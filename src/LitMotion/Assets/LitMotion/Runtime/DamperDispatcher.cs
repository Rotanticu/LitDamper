...
namespace LitDamper
{
    ...
    /// Motion dispatcher.
    /// </summary>
    public static class DamperDispatcher
    {
        ...
        {
            public static DamperStorage<TValue, TOptions, TAdapter> initialization;
            public static DamperStorage<TValue, TOptions, TAdapter> earlyUpdate;
            public static DamperStorage<TValue, TOptions, TAdapter> fixedUpdate;
            public static DamperStorage<TValue, TOptions, TAdapter> preUpdate;
            public static DamperStorage<TValue, TOptions, TAdapter> update;
            public static DamperStorage<TValue, TOptions, TAdapter> preLateUpdate;
            public static DamperStorage<TValue, TOptions, TAdapter> postLateUpdate;
            public static DamperStorage<TValue, TOptions, TAdapter> timeUpdate;

            public static DamperStorage<TValue, TOptions, TAdapter> GetOrCreate(PlayerLoopTiming playerLoopTiming)
            {
            ...
            static DamperStorage<TValue, TOptions, TAdapter> CreateIfNull(ref DamperStorage<TValue, TOptions, TAdapter> storage)
            {
                if (storage == null)
                {
                    storage = new DamperStorage<TValue, TOptions, TAdapter>(MotionStorageManager.CurrentStorageId);
            ...
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
            ...
            public static (UpdateRunner<TValue, TOptions, TAdapter> runner, bool isCreated) GetOrCreate(PlayerLoopTiming playerLoopTiming, DamperStorage<TValue, TOptions, TAdapter> storage)
            {
                return playerLoopTiming switch
                {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static (UpdateRunner<TValue, TOptions, TAdapter>, bool) CreateIfNull(PlayerLoopTiming playerLoopTiming, ref UpdateRunner<TValue, TOptions, TAdapter> runner, DamperStorage<TValue, TOptions, TAdapter> storage)
            {
                if (runner == null)
                {
        ...
        internal static DamperHandle Schedule<TValue, TOptions, TAdapter>(in DamperData<TValue, TOptions> data, in DamperCallbackData callbackData, PlayerLoopTiming playerLoopTiming)
            where TValue : unmanaged
            where TOptions : unmanaged, IDamperOptions
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
    ...
    internal static class EditorMotionDispatcher
    {
        static class Cache<TValue, TOptions, TAdapter>
            ...
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
            static DamperStorage<TValue, TOptions, TAdapter> storage;
            static UpdateRunner<TValue, TOptions, TAdapter> updateRunner;

            public static DamperStorage<TValue, TOptions, TAdapter> GetOrCreateStorage()
            {
                if (storage == null)
                {
                    storage = new DamperStorage<TValue, TOptions, TAdapter>(MotionStorageManager.CurrentStorageId);
        ...
        public static DamperHandle Schedule<TValue, TOptions, TAdapter>(in DamperData<TValue, TOptions> data, in DamperCallbackData callbackData)
            where TValue : unmanaged
            where TOptions : unmanaged, IDamperOptions
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
