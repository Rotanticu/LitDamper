...
namespace LitDamper
{
    ...
    public static partial class LDamper
    {
        ...
        public static DamperBuilder<float, NoOptions, FloatMotionAdapter> CreateDamper(Func<float> getCurrentValue,Action<float> setCurrentValue, Func<float> getTargetValue) => CreateDamper<float, NoOptions, FloatMotionAdapter>(()=>(double)getCurrentValue(), (value) => setCurrentValue((float)value), () => (double)getTargetValue());
            ...
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
            ...
            buffer.Data.Core.CurrentValue = getCurrentValue();
            buffer.Data.Core.TargetValue = getTargetValue();
