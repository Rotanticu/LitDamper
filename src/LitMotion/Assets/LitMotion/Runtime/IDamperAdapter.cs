namespace LitDamper
{
    ...
    public interface IDamperAdapter<TValue, TOptions>
        ...
        where TOptions : unmanaged, IDamperOptions
    {
        ...
        TValue Evaluate(ref TValue startValue, ref TValue endValue, ref TOptions options, in DamperEvaluationContext context);
    }
}