...
namespace LitDamper
{
    public static class LitMotionR3Extensions
    {
        ...
        public static Observable<TValue> ToObservable<TValue, TOptions, TAdapter>(this DamperBuilder<TValue, TOptions, TAdapter> builder)
        ...
        public static DamperHandle BindToReactiveProperty<TValue, TOptions, TAdapter>(this DamperBuilder<TValue, TOptions, TAdapter> builder, ReactiveProperty<TValue> reactiveProperty)
            where TValue : unmanaged
            where TOptions : unmanaged, IDamperOptions
            where TAdapter : unmanaged, IDamperAdapter<TValue, TOptions>
        {
